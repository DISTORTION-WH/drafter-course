...
[data/matches.json](data/matches.json.md) содержит вымышленные учебные матчи. Команды, игроки, match ID и статистика не описывают реальные события.

## Основные файлы

- [models.ts](src/domain/models.ts.md) — domain types;
- [parse-match-history.ts](src/domain/parse-match-history.ts.md) — runtime validation и normalization;
- [history-analytics.ts](src/domain/history-analytics.ts.md) — чистые расчёты;
- [read-json.ts](src/io/read-json.ts.md) — файловая граница;
- [index.ts](src/index.ts.md) — composition root.
