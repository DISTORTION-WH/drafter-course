# Файл `print-history-report.ts`

Исходный путь в учебном комплекте: `course/part-04-typescript/examples/dota-history-cli-ts/src/presentation/print-history-report.ts`.
