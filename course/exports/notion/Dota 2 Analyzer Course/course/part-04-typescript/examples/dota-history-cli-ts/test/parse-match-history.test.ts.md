# Файл `parse-match-history.test.ts`

Исходный путь в учебном комплекте: `course/part-04-typescript/examples/dota-history-cli-ts/test/parse-match-history.test.ts`.
