# Файл `history-analytics.test.js`

Исходный путь в учебном комплекте: `course/part-03-advanced-javascript/examples/dota-history-cli/test/history-analytics.test.js`.
