# Файл `history-analytics.js`

Исходный путь в учебном комплекте: `course/part-03-advanced-javascript/examples/dota-history-cli/src/domain/history-analytics.js`.
