...
[src/data/match.js](examples/dota-match-cli/src/data/match.js) экспортирует fixture. Domain не знает, откуда объект был получен.
...
[src/domain/calculations.js](examples/dota-match-cli/src/domain/calculations.js) содержит чистые расчёты без console, файлов и сети.

Это самый простой для тестирования слой.

## 4. Почему validation отдельно

[src/domain/validation.js](examples/dota-match-cli/src/domain/validation.js) описывает допустимую форму входа.
...
[src/domain/match-report.js](examples/dota-match-cli/src/domain/match-report.js) координирует:
...
[src/presentation/print-report.js](examples/dota-match-cli/src/presentation/print-report.js) знает о консоли и текстовом формате.
...
[src/index.js](examples/dota-match-cli/src/index.js) является composition root:
...
- [calculations.test.js](examples/dota-match-cli/test/calculations.test.js) — чистые формулы;
- [validation.test.js](examples/dota-match-cli/test/validation.test.js) — правила входа;
- [match-report.test.js](examples/dota-match-cli/test/match-report.test.js) — общий domain use case.
